...
- **Fonts** - Ovo (Google Fonts, titles/headings), Mulish (Google Fonts, body/UI), and self-hosted MesloLGM Nerd Font Mono Regular (inline code, code blocks, and `<pre>`). These are the only three typefaces used by the app.
